...
if __name__ == "__main__":
    # Self-contained demo using the same maze the mock produces.
    sample_grid = [
        [0xD, 0x5, 0x5, 0x3],
        [0x9, 0x5, 0x5, 0x6],
        [0xC, 0x5, 0x5, 0x3],
    ...
    write_maze("demo_maze.txt", sample_grid, (0, 0), (3, 3), "EEESWWWSEEES")
    with open("demo_maze.txt", encoding="utf-8") as fh:
        print(fh.read(), end="")
